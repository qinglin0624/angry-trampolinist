...
int fsrReading;
int LEDbrightness;
float XtransitionDelta;
float YtransitionDelta;
float XtransitionInitial = 0.02;
float YtransitionInitial = 0.5;
float Xtransition;
float Ytransition;
...
void setup() {
  ...
  // setup for playing page: arduino, initialize ball, paddle, and user 2
...
public void initializeGame(){
  ...
  Xfriction = 0.7;
  Yfriction = 0.7;
  Xtransition = XtransitionInitial;
  Ytransition = YtransitionInitial;
